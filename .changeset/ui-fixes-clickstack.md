...
- **Semantic colors**: Updated semantic color functions (CHART_COLOR_SUCCESS, CHART_COLOR_WARNING, CHART_COLOR_ERROR) to be theme-aware, reading from CSS variables or falling back to theme-appropriate palettes.
