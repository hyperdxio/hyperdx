...
feat(dashboards): smart views sidebar with tag-only rules on the Dashboards listing page

Save reusable filter combinations as named "smart views" pinned to a
...
Backed by a new `/smart-views` CRUD endpoint scoped per user and per
