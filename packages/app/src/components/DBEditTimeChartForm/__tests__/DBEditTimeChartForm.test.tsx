...
// NOTE (Berg / Task 9): the chart-tile alert UI was removed as part of the
// observability strip — alerts are out of v1. The previous tests for
// add/remove/schedule alerts have been deleted accordingly.
