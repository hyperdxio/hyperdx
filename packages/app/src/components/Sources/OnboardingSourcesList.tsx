...
/**
 * Berg legacy onboarding-flavoured sources list. The Berg Sources page lives
 * at `packages/app/src/components/Sources/SourcesList.tsx`; this embedded
 * variant is kept around for the Onboarding modal and Team Settings panel
 * until those flows are reworked.
 */
export interface OnboardingSourcesListProps {
...
export function OnboardingSourcesList({
  onAddSource,
  withCard = true,
  withBorder = true,
  cardClassName,
