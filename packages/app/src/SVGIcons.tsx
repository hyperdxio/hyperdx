...
// Brand marks for AI agent providers (paths from simple-icons, CC0).
// The Claude Code terminal glyph is used for managed agents — most
// recognisable of the Claude marks at 16px. `currentColor` so it follows the
// theme like every other icon.
export function ClaudeCodeIcon({ style, width = 16 }: IconProps) {
  return (
    <svg
      width={width}
      height={width}
...
export function CursorAIIcon({ style, width = 16 }: IconProps) {
  return (
    <svg
      width={width}
      height={width}
