...
test.describe('Saved Search Functionality', () => {
  ...
  test('should preserve custom SELECT when navigating between saved searches', async ({
    page,
  }) => {
    /**
  ...
  test('should restore saved search SELECT after switching sources', async ({
    page,
  }) => {
    /**
  ...
  test('should use default SELECT when switching sources within a saved search', async ({
    page,
  }) => {
    ...
    await test.step('Verify SELECT changed to the new source default', async () => {
      ...
      expect(selectContent).not.toContain('lower(ServiceName) as service_name');
      expect(selectContent).toMatch(/Timestamp/i);
    });
  ...
  test('should load saved search when navigating from another page', async ({
    page,
  }) => {
    /**
  ...
  test('should preserve custom SELECT when loading saved search from another page', async ({
    page,
  }) => {
    /**
    ...
    let savedSearchUrl: string;
    const customSelect = 'Timestamp, Body, upper(ServiceName) as service_name';
  ...
  test('should update ORDER BY when switching sources multiple times', async ({
    page,
  }) => {
    /**
  ...
  test('should save and restore filters with saved searches', async ({
    page,
  }) => {
    /**
  ...
  test('should update filters when updating a saved search', async ({
    page,
  }) => {
    /**
