  ...
  webServer: USE_FULLSTACK
    ? [
        ...
        },
        {
          ...
          command: USE_DEV
            ? `SERVER_URL=http://localhost:${API_PORT} PORT=${APP_PORT} NEXT_PUBLIC_ENABLE_ALERT_DETAILS=true NEXT_DIST_DIR=.next-e2e next dev --webpack`
            : `SERVER_URL=http://localhost:${API_PORT} PORT=${APP_PORT} NEXT_PUBLIC_ENABLE_ALERT_DETAILS=true NEXT_DIST_DIR=.next-e2e yarn build && SERVER_URL=http://localhost:${API_PORT} PORT=${APP_PORT} NEXT_PUBLIC_ENABLE_ALERT_DETAILS=true NEXT_DIST_DIR=.next-e2e yarn start`,
