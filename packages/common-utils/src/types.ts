...
// TABLE SOURCES (Berg)
// --------------------------
// In Berg, a Source represents a single Athena/Iceberg table. The legacy
// HyperDX discriminated union (Log/Trace/Session/Metric) has been collapsed
// to the single `Table` kind. Downstream consumers should treat every
// Source as a Berg-native Athena table.
